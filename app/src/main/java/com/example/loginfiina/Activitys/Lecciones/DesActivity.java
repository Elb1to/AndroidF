...
public class DesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video.setOnClickListener(Dv -> {
            Intent VideoD= new Intent(com.example.loginfiina.Activitys.Lecciones.DesActivity.this, VideoLecturaActivity.class);
        ...
        back.setOnClickListener(Dv3 -> {
            Intent Retorno2 = new Intent(com.example.loginfiina.Activitys.Lecciones.DesActivity.this, LeccionActivity.class);
