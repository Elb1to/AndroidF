...
public class SelectConversation extends AppCompatActivity {
    ...
    private void setSpnTema() {
        spnT = (Spinner)findViewById(R.id.spnTema);
    ...
    private void setSpinnerSubTema(List<SubTemas> list) {
        ...
        spnSubT = (Spinner) findViewById(R.id.spnSubtema);
    ...
    private void getSubTemas(int sel) {
        ...
        Call<List<SubTemas>> call = service.getSubTemas(sel);
    ...
    public void itemSelected(View v) {
        ...
        Intent intent = new Intent(this, com.example.lecchat.ConversacionActivity.class);
